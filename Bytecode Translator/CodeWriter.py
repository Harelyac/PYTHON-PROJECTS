...
class CodeWriter:
    ...
    def EqualCommand(self):
        ...
        return ["@SP\nAM = M-1\nD=M\n@POSITIVE" + str(self.countJumps) + "\nD;JGT\n@NEGATIVE" + str(self.countJumps) + "\n"
                "D;JLT\n@CHECK" +str(self.countJumps) + "\n0;JMP\n(POSITIVE" + str(self.countJumps) + ")\n@SP\nA=M\nA=A-1\nD=M\n"
                "@CHECK" +str(self.countJumps) + "\nD;JGT\n@NOTEQUAL" + str(self.countJumps) + "\n0;JMP\n(NEGATIVE" + str(self.countJumps) + ")\n"
                "@SP\nA=M\nA=A-1\nD=M\n@CHECK" +str(self.countJumps) +"\nD;JLT\n@NOTEQUAL" + str(self.countJumps) +"\n0;JMP\n"
                "(CHECK" + str(self.countJumps) + ")\n@SP\nA=M\nD=M\nA=A-1\nD=D-M\n@EQUAL" +str(self.countJumps) +"\nD;JEQ\n@NOTEQUAL" + str(self.countJumps) + "\n"
